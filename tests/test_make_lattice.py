...
from wiki_node_disambiguation.models import WikipediaArticleObject, LatticeObject
import unittest
import os
...
class TestMakeLatice(unittest.TestCase):
    ...
    def test_make_state_transition_matrix(self):
        ...
        self.assertEqual(transition_edge[0][2], self.model_object.similarity('[ヤマハ]', '[河合楽器製作所]'))
